<?php
/**
 * Plugin Name: CPT Stark Upcoming
 * Description: Creates the "Stark Upcoming" CPT.
 * Author: Eric Defore
...
if ( ! class_exists( 'SportsTM_Stark_Upcoming' ) ) {

    /**
     * Main SportsTM_Stark_Upcoming class
     *
     * @since       1.0.0
     */
    class SportsTM_Stark_Upcoming {

        /**
         * @var         SportsTM_Stark_Upcoming $instance The one true SportsTM_Stark_Upcoming
         * @since       1.0.0
         */
         ...
         * @since       1.0.0
         */
        private $name = 'stark_upcoming';

        /**
         * @var         Singular Name for our CPT
         * @since       1.0.0
         */
        private $singular = 'Stark Upcoming';

        /**
         * @var         Plural Name for our CPT
         * @since       1.0.0
         */
        private $plural = 'Stark Upcoming';

        /**
         * @var         Menu Icon for our CPT
         * @since       1.0.0
         */
        private $icon = '/images/cpt-stark-upcoming.png';
         ...
         * @access      public
         * @since       1.0.0
         * @return      object self::$instance The one true SportsTM_Stark_Upcoming
         */
        public static function get_instance() {

            if ( ! self::$instance ) {

                self::$instance = new SportsTM_Stark_Upcoming();
        ...
        private function setup_constants() {
            ...
            // Plugin version
            define( 'SportsTM_Stark_Upcoming_VER', '1.0.0' );
            // Plugin path
            define( 'SportsTM_Stark_Upcoming_DIR', plugin_dir_path( __FILE__ ) );
            // Plugin URL
            define( 'SportsTM_Stark_Upcoming_URL', plugin_dir_url( __FILE__ ) );
...
/**
 * The main function responsible for returning the one true SportsTM_Stark_Upcoming
 * instance to functions everywhere
 *
 * @since       1.0.0
 * @return      \SportsTM_Stark_Upcoming The one true SportsTM_Stark_Upcoming
 */
add_action( 'plugins_loaded', 'SportsTM_Stark_Upcoming_load' );
function SportsTM_Stark_Upcoming_load() {

    return SportsTM_Stark_Upcoming::get_instance();
